...
- [x] The index.html file should NOT be edited!
  <!-- **Note: Eric told me to add the responsive meta tag in all-questions**->
...
- [x] The index.html file must remain unchanged. **Note: Eric told me to add the responsive meta tag in all-questions**
